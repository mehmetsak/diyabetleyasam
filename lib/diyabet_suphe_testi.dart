...
class DiyabetSupheTesti extends StatefulWidget {
  @override
  _DiyabetSupheTestiState createState() => _DiyabetSupheTestiState();
}

class _DiyabetSupheTestiState extends State<DiyabetSupheTesti> {
  int secim0 = 0,
      secim1 = 0,
      secim2 = 0,
      secim3 = 0,
        ...
        actions: <Widget>[
          new RaisedButton(
              ...
              onPressed: () {
                ...
                sonuc = 0;
                Navigator.pop(context);
                Navigator.pushReplacementNamed(context, '/suphetesti');
                // Navigator.push(
                //   context,
                // MaterialPageRoute(
